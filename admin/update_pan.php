      ...
      <div class="br-pagebody" >
            ...
            <div class="col-xl-5">
              <div class="form-layout form-layout-4"style="background-color:#0BC4CB;border-radius:15px;">
               ...
               <form action="" method="">
	         <center> <input type="text" class="form-control" placeholder="PAN no" style="width:400px"></center><br><br>
				<center><img src="img/pan.jpeg" style="width:300px; border-radius:20px;"></center><br><br><br>
